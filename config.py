...
def parse_args():
	...
	parser.add_argument('--pre_epoch', type=int, default=20, help=None)
	parser.add_argument('--pre_step', type=int, default=20, help=None)
	parser.add_argument('--epoch', type=int, default=10, help=None)
	parser.add_argument('--step', type=int, default=10, help=None)
