...
def parse_args():
	...
	parser.add_argument('--transition_function', default='T1', help='Transition function [T1, T2, L1, L2]')
	parser.add_argument('--random_walk_step', default=1, help=None)
	parser.add_argument('--stay_prob', default=0.2, help='Probability of staying at current node')
