...
def parse_args():
	...
	parser.add_argument('--gpu_memory_fraction', type=float, default= 0.5, help='fraction of gpu memory per process')
	parser.add_argument('--batch_gpu_process', type=int, default= 2, help='Number of processes allowed on one GPU')
	...
	parser.add_argument('--transition_function', type=str, default='T', help='Transition function [T, RI, RW]')
