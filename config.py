...
def parse_args():
	...
	parser.add_argument('--transition_function', type=str, default='RI1', help='Transition function [T1, T2, L1, L2, RI1, RI2]')
	...
	parser.add_argument('--lambda_2', type=float, default=0.1, help='L2 loss for soft assigned cluster center')
	...
	parser.add_argument('--pre_epoch', type=int, default=40, help=None)
	parser.add_argument('--pre_step', type=int, default=40, help=None)
	parser.add_argument('--epoch', type=int, default=20, help=None)
	parser.add_argument('--step', type=int, default=20, help=None)
